...
<details>
 ...
 git clone https://github.com/GrantDerdeynBlackwell/3D-Additively-Weighted-Voronoi-Diagram.git && cd 3D-Additively-Weighted-Voronoi-Diagram && cmake -DCGAL_DIR="../cgal-5.4" -DCMAKE_BUILD_TYPE="Release" . && make
 ```
</details>
